...
namespace BitWave_Labs.AnimatedTextReveal
{
    ...
    public class AnimatedTextReveal : MonoBehaviour
    {
        ...
        /// <summary>
        /// Allows parent controllers to reuse this reveal component for generated or child TMP labels.
        /// </summary>
        public void Configure(TextMeshProUGUI text, float speed, int spread)
        {
            textMesh = text;
            fadeSpeed = speed;
            characterSpread = Mathf.Max(1, spread);
        }
